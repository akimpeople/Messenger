...
class RegisterViewController: UIViewController {
    ...
    private let addPhoto: UILabel = {
        let addPhoto = UILabel()
        addPhoto.text = "Set Profile Picture"
        addPhoto.textColor = .gray
        return addPhoto
    }()
    ...
    override func viewDidLoad() {
        ...
        let gestureAddPhoto = UITapGestureRecognizer(target: self,
                                                     action: #selector(didTapChangeProfilePicture))
    ...
    override func viewDidLayoutSubviews() {
        ...
        addPhoto.frame = CGRect(x: (scrollView.width-size)/2,
                                y: imageView.bottom+5,
                                width: size,
                                height: 30)
        
        firstNameField.frame = CGRect(x: 30,
                                      y: addPhoto.bottom+10,
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Set Profile picture",
                                            message: .none,
